...
// Debug
#define DEBUG_LED_PORT					GPIO_PORTD_BASE
#define DEBUG_LED_PIN					GPIO_PIN_4

#define DEBUG_LED_TIMER					TIMER2_BASE

/*
 * DASH / INDICATOR
 */
#define DASH_IGNITION_PIN				GPIO_PIN_0
#define DASH_IGNITION_PORT				GPIO_PORTB_BASE

#define DASH_MPPT_PORT					GPIO_PORTB_BASE
#define DASH_MPPT_PIN					GPIO_PIN_1

#define DASH_RELAY_FORCE_PIN			GPIO_PIN_2
#define DASH_RELAY_FORCE_PORT			GPIO_PORTB_BASE

// indicator LED
#define DASH_LED_RED_PIN				GPIO_PIN_0
#define DASH_LED_GREEN_PIN				GPIO_PIN_1
#define DASH_LED_BLUE_PIN				GPIO_PIN_2

#define DASH_LED_PORT					GPIO_PORTG_BASE

#define DASH_LED_BLUE_PINMAP			GPIO_PG2_T5CCP0
#define DASH_LED_GREEN_PINMAP			GPIO_PG1_T4CCP1
#define DASH_LED_RED_PINMAP				GPIO_PG0_T4CCP0

#define DASH_LED_BLINK_TIMER_BASE		TIMER1_BASE

// Relays
#define CHG_RLY_PORT					GPIO_PORTA_BASE
#define CHG_RLY_PIN						GPIO_PIN_4

#define DISCHG_RLY_PORT					GPIO_PORTA_BASE
#define DISCHG_RLY_PIN					GPIO_PIN_5

#define SOLAR_RLY_PORT					GPIO_PORTA_BASE
#define SOLAR_RLY_PIN					GPIO_PIN_6

#define BATPOS_RLY_PORT					GPIO_PORTA_BASE
#define BATPOS_RLY_PIN					GPIO_PIN_7

#define BATNEG_RLY_PORT					GPIO_PORTF_BASE
#define BATNEG_RLY_PIN					GPIO_PIN_0
